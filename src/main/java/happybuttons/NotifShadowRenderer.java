...
class NotifShadowRenderer {
    ...
    public NotifShadowRenderer() {
        this(5, 0.5f, Color.BLACK);
    }

    public NotifShadowRenderer(final int size, final float opacity, final Color color) {
        this.size = size;
    ...
    public BufferedImage createShadow(final BufferedImage image) {
        ...
        UtilityGraphics.getPixels(image, 0, 0, srcWidth, srcHeight, srcBuffer);
        ...
        UtilityGraphics.setPixels(dst, 0, 0, dstWidth, dstHeight, dstBuffer);
        return dst;
    }
}