...
public class SliderMpPlaybackGradientUI extends BasicSliderUI {
    private SliderMpPlaybackGradient sliderGradient;

    public SliderMpPlaybackGradientUI(SliderMpPlaybackGradient sliderGradient) {
