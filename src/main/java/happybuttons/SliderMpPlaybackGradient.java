...
public class SliderMpPlaybackGradient extends JSlider {
    ...
    private Color color1 = new Color(182, 180, 0, 255); // left side of slider gradient
    ...
    public SliderMpPlaybackGradient() {
        setUI(new SliderMpPlaybackGradientUI(this));
    }
}