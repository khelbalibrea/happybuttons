...
public class SliderBGMGradientUI extends BasicSliderUI {
    private SliderBGMGradient sliderGradient;

    public SliderBGMGradientUI(SliderBGMGradient sliderGradient) {
