...
public class SliderSFXGradientUI extends BasicSliderUI {
    private SliderSFXGradient sliderGradient;

    public SliderSFXGradientUI(SliderSFXGradient sliderGradient) {
