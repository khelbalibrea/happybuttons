 ...
 */
public class DnDBGMLabel extends TransferHandler {
    ...
    public boolean importData(TransferSupport ts) {System.out.println("Hi");
        try {
            ((JLabel) ts.getComponent()).setText((String) ts.getTransferable().getTransferData(DataFlavor.stringFlavor));
