...
public class SliderVidVolGradientUI extends BasicSliderUI {
    private SliderVidVolGradient sliderGradient;

    public SliderVidVolGradientUI(SliderVidVolGradient sliderGradient) {
